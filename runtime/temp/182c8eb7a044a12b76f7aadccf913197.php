<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view/index\index.html";i:1550211805;s:83:"F:\phpstudy\PHPTutorial\WWW\TPshop_20181023\application\admin\view\public\left.html";i:1550210609;}*/ ?>
<!doctype html>
<html>
<head>
...
<title><?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:'APshop商城'); ?></title>
...
<div class="admincp-header">
	...
	<div class="admincp-name" onClick="javascript:openItem('welcome|Index');">
		<!-- <h2 style="cursor:pointer;">APshop3.0<br>平台系统管理中心</h2> -->
...
<div class="admincp-container-left">
    ...
    <?php endforeach; endif; else: echo "" ;endif; ?> 
    <div class="about" title="关于系统" onclick="javascript:layer.open({type: 2,title: '关于我们',shadeClose: true,shade: 0.3,area: ['50%', '60%'],content:'<?php echo U("Index/about"); ?>', });"><i class="fa fa-copyright"></i><span>APshop.cn</span></div>
</div>
